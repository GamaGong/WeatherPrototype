package com.example.weatherprototype.app.details.pager

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.LinearLayoutManager
import androidx.recyclerview.widget.RecyclerView
import com.example.weatherprototype.app.details.list.DetailsListAdapter
...
class DetailsPagerAdapter : RecyclerView.Adapter<PagerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PagerViewHolder =
        PagerViewHolder(
            DetailsViewpagerItemBinding.inflate(
